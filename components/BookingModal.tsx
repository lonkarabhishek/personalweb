      ...
      {isOpen && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative w-full max-w-4xl h-[80vh] bg-dark-light rounded-2xl border border-white/10 overflow-hidden shadow-2xl"
            ...
            <div className="flex items-center justify-between p-4 border-b border-white/10">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-white/50 text-sm">Choose a time that works for you</p>
                </div>
              </div>
              <motion.button
